    ...
    components: {
      ...
      schemas: {
        AgentSearchResponse: {
          ...
          properties: {
            schema_version: { type: 'string' },
            ranking_policy: { type: 'string', const: 'nexez.discovery-ranking.v1' },
            query: { type: 'string' },
        ...
        AgentSearchResult: {
          ...
          properties: {
            ...
            ranking: {
              type: 'object',
              properties: {
                policy_version: { type: 'string', const: 'nexez.discovery-ranking.v1' },
                relevance: { type: 'number' },
                location: { type: 'string' },
                availability: { type: 'string' },
                actionability: { type: 'string' },
                seller_verified: { type: 'boolean' },
                agent_ready_certified: { type: 'boolean' },
                verified_purchase_reviews: { type: 'integer' },
                reputation: { type: ['number', 'null'] },
