...
import type { NexxiTurnPayload } from '../../../contracts/nexxi/v1'
import {
  NexxiA2AV1Projector,
...
const baseResult: NexxiTurnPayload = {
  threadId: 'thread-1',
  agentId: 'agent-1',
  message: 'Found one.',
  cards: [],
...
function projector() {
  return new NexxiA2AV1Projector(
    {
      taskId: 'task-1',
      contextId: 'context-1',
...
describe('NexxiA2AV1Projector', () => {
  ...
  it('fails early on missing or oversized projection identifiers', () => {
    expect(() => new NexxiA2AV1Projector({
      taskId: ' ',
      contextId: 'context-1',
