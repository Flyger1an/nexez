...
export const commerceSchemaGapFindings: CommerceSchemaGapFinding[] = [
  ...
  },
  {
    ...
    disposition: 'weakly-structured',
    action: 'harden-existing',
    currentRepresentation: 'Negotiation publishes a typed vocabulary for scope, deliverables, revision count, and project length. Smart Rules evaluate those terms deterministically, block automatic acceptance on missing or outside-limit terms, and retain unknown fields for seller review.',
    missingBehavior: 'Accepted typed terms are not yet normalized into an independently enforceable agreement snapshot after negotiation.',
    recommendation: 'Use the typed vocabulary for repeated transaction-critical terms, keep free-form negotiation for the long tail, and add post-agreement enforcement only with a normalized agreement model.',
    evidence: ['lib/negotiation-terms.ts', 'lib/offer-rules.ts', 'lib/negotiation.service.ts', 'lib/agent-capabilities.ts'],
  },
  {
