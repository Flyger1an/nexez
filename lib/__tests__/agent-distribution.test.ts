...
describe('agent distribution metadata', () => {
  it('exposes install commands for the OpenClaw plugin and skill', () => {
    ...
    expect(NEXEZ_TYPESCRIPT_SDK.version).toBe('0.1.0')
    ...
    expect(NEXEZ_PYTHON_SDK.version).toBe('0.1.0')
  ...
  it('builds public agent links from the supplied runtime base', () => {
    ...
    expect(links.sdks.typescript.version).toBe('0.1.0')
    ...
    expect(links.sdks.python.version).toBe('0.1.0')
