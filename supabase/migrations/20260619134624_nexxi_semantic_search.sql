...
create or replace function public.match_nexxi_pages(query_embedding extensions.vector(1536), match_count int default 40)
...
revoke all on function public.match_nexxi_pages(extensions.vector, int) from public;
grant execute on function public.match_nexxi_pages(extensions.vector, int) to authenticated, service_role;
