...
const sections: { heading: string; body: string[] }[] = [
  ...
  {
    heading: '8. AI Processing & Automated Assistance',
    body: [
  ...
  {
    heading: '10. How We Disclose Information',
    body: [
  ...
  {
    heading: '11. Shopify Privacy Requests',
    body: [
  ...
  {
    heading: '12. Cookies & Similar Technologies',
    body: [
  ...
  {
    heading: '14. Your Choices & Privacy Rights',
    body: [
  ...
  {
    heading: '15. Security & International Processing',
    body: [
