...
// the gate, so no Shopify Admin-API call is reached.
...
const post = (body: unknown) =>
  new Request('https://nexez.app/api/integrations/shopify/import', {
    method: 'POST', headers: { 'content-type': 'application/json' }, body: JSON.stringify(body),
  })

describe('POST /api/integrations/shopify/import (collaboration gate)', () => {
  beforeEach(() => {
    vi.clearAllMocks()
  ...
  it('403 when resolveFeatureOwner denies — never calls the Shopify Admin API', async () => {
