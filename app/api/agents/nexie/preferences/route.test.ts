...
const get = () => new Request('https://nexez.test/api/agents/nexie/preferences') as any
const patch = (body: unknown, raw = false) =>
  new Request('https://nexez.test/api/agents/nexie/preferences', {
    method: 'PATCH',
...
describe('GET /api/agents/nexie/preferences', () => {
...
describe('PATCH /api/agents/nexie/preferences', () => {
