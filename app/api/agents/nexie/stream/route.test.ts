...
vi.mock('../../../../../lib/agents/nexie', () => ({ handleNexieTurn: vi.fn((input: any) => turnRef.impl(input)) }))

import { POST } from './route'

const req = (body: unknown = { message: 'hi' }) =>
  new Request('https://nexez.test/api/agents/nexie/stream', {
    method: 'POST',
...
describe('POST /api/agents/nexie/stream', () => {
