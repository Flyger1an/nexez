...
const getReq = () => new Request('https://nexez.test/api/agents/nexxi/threads/t1') as any
const patchReq = (body: unknown, raw = false) =>
  new Request('https://nexez.test/api/agents/nexxi/threads/t1', {
    method: 'PATCH',
...
describe('GET /api/agents/nexxi/threads/[id]', () => {
...
describe('PATCH /api/agents/nexxi/threads/[id]', () => {
