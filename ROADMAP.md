...
_Last reconciled: 2026-08-21 against production and `origin/main` at `fe2b69e`._
...
1. **Curate launch inventory.** Apply the additive Commerce supply-campaign migration, then use Launch Control's deterministic recruitment briefs and audited lifecycle to publish and certify 20-30 high-quality storefronts across representative industries and regions, while resolving catalog overlap/replacement reviews before recruiting against them. The 2026-08-21 live baseline is 3 published/serving storefronts, 1 certified listing, and 10 curation candidates. Only uniquely classified published offers on currently certified listings close a category; operator status, adjacent supply, synthetic Commerce Library scenarios, benchmark fixtures, and simulator interactions never count toward this target or prove conversion.
